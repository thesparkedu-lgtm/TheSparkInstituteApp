...
class Class12 : MyTranslationFragment(R.layout.fragment_class12) , OnMapReadyCallback {
    ...
    override fun onCreateView(
      ...
      val view = inflater.inflate(R.layout.fragment_class12, container, false)

        val whatsappButton = view.findViewById<LinearLayout>(R.id.WhatsappBtnClass12)
