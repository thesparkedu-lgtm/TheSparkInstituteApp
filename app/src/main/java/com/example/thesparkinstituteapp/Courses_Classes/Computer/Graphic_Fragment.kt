...
class Graphic_Fragment : MyTranslationFragment(R.layout.fragment_graphic_) , OnMapReadyCallback {
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_graphic_, container, false)

        val whatsappButton = view.findViewById<LinearLayout>(R.id.WhatsappBtnGraphicDesign)
