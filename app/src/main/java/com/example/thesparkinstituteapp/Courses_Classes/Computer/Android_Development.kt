...
class Android_Development : MyTranslationFragment(R.layout.fragment_android__development_) , OnMapReadyCallback {
    ...
    override fun onCreateView(
      ...
      val view = inflater.inflate(R.layout.fragment_android__development_, container, false)

        val whatsappButton = view.findViewById<LinearLayout>(R.id.WhatsappBtnAndroidDev)
