...
class SSC_GD : MyTranslationFragment(R.layout.fragment_s_s_c__g_d) , OnMapReadyCallback {
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_s_s_c__g_d, container, false)

        val whatsappButton = view.findViewById<LinearLayout>(R.id.WhatsappBtnSSC_GD)
