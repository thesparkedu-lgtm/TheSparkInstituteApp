...
class SpokenEnglish : MyTranslationFragment(R.layout.fragment_spoken_english) , OnMapReadyCallback {
    ...
    override fun onCreateView(
       ...
       val view = inflater.inflate(R.layout.fragment_spoken_english, container, false)

        val whatsappButton = view.findViewById<LinearLayout>(R.id.WhatsappBtnSpokenEng)
