...
class ADCA_Fragment : MyTranslationFragment(R.layout.fragment_a_d_c_a_) , OnMapReadyCallback {
    ...
    override fun onCreateView(
      ...
      val view =  inflater.inflate(R.layout.fragment_a_d_c_a_, container, false)

        val whatsappButton = view.findViewById<LinearLayout>(R.id.WhatsappBtnADCA)
