...
class Java_Fragment : MyTranslationFragment(R.layout.fragment_java_) , OnMapReadyCallback {
 ...
 override fun onCreateView(
     ...
     val view =  inflater.inflate(R.layout.fragment_java_, container, false)

     val whatsappButton = view.findViewById<LinearLayout>(R.id.WhatsappBtnJavaOops)
