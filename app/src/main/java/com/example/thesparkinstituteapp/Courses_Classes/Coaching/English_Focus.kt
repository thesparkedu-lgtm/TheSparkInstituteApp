...
class English_Focus : MyTranslationFragment(R.layout.fragment_english__focus) , OnMapReadyCallback {
    ...
    override fun onCreateView(
       ...
       val view = inflater.inflate(R.layout.fragment_english__focus, container, false)
        val whatsappButton = view.findViewById<LinearLayout>(R.id.WhatsappBtnEng_Focus)
