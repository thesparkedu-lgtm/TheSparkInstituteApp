...
class DCA_Fragment : MyTranslationFragment(R.layout.fragment_d_c_a_) , OnMapReadyCallback {
    ...
    override fun onCreateView(
     ...
     val view =  inflater.inflate(R.layout.fragment_d_c_a_, container, false)

        val whatsappButton = view.findViewById<LinearLayout>(R.id.WhatsappBtnDCA)
