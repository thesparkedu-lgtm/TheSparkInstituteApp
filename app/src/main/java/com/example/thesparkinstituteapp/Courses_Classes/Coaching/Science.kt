...
class Science :MyTranslationFragment(R.layout.fragment_science) , OnMapReadyCallback {
    ...
    override fun onCreateView(
      ...
      val view = inflater.inflate(R.layout.fragment_science, container, false)
        val whatsappButton = view.findViewById<LinearLayout>(R.id.WhatsappBtnScience)
