...
class WB_Police : MyTranslationFragment(R.layout.fragment_w_b__police) , OnMapReadyCallback {
    ...
    val instituteLocation = LatLng(26.793823, 89.023983)
     override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_w_b__police, container, false)
         val whatsappButton = view.findViewById<LinearLayout>(R.id.WhatsappBtnWBpolice)
